...
*
*       Copyright   (c) 2014
*       Company     iSYS RTS GmbH
*
*       \file       bus_handler.c
*       PROJECT     RR SMG Modul
*       MODUL       bus_component
*
*       REVISION    $LastChangedRevision: 142 $
*       \author     s.eisele
*       CHANGED     $LastChangedDate: 2014-03-20 14:39:02 +0100 (Do, 20 Mrz 2014) $
*       BY          $LastChangedBy: m.albrecht $
*
*       -------------------------------------------------------------------------
*       DESCRIPTION
*       -------------------------------------------------------------------------
